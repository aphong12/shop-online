    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item">
            <div class="top-nav-search">
                ...
                <form action="#">
                    ...
                    <a class="btn" id="searchdiv"><img src="admin/assets/img/icons/search.svg" alt="img"></a>
                </form>
            </div>
        </li>
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <img src="admin/assets/img/icons/notification-bing.svg" alt="img"> <span class="badge rounded-pill">4</span>
            </a>
...
<span class="status online"></span></span>
                    ...
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="signin.html"><img src="admin/assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
                </div>
            </div>
        </li>
    </ul>
